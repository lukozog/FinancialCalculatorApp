...
public class UserExpensesController {
    ...
    public double getExpenses(@PathVariable long userId,@PathVariable @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate minDate, @PathVariable @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate maxDate) {
        return userExpenseService.getExpenses(userId, minDate, maxDate);
    }

    @GetMapping("/{userId}/{minDate}/{maxDate}/{expenseTypeId}")
    public double getExpenses(@PathVariable long userId, @PathVariable @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate minDate, @PathVariable @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate maxDate, @PathVariable long expenseTypeId) {
