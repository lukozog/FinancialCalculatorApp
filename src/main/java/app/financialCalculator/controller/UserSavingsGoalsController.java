...
public class UserSavingsGoalsController {
    ...
    public ResponseEntity<LocalDate> savingsGoalDateByDailySavings(@PathVariable long userId, @PathVariable long savingsGoalId, @PathVariable double dailySavings) {
    ...
    public ResponseEntity<LocalDate> savingsGoalDateByMonthlySavings(@PathVariable long userId, @PathVariable long savingsGoalId, @PathVariable double monthlySavings) {
    ...
    public ResponseEntity<Double> savingsGoalDailySavingTillDate(@PathVariable long userId, @PathVariable long savingsGoalId, @PathVariable @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate dateOfAccomplishment) {
